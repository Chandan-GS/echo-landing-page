...
export function LaptopIcon(props: IconProps) {
  return (
    <svg {...svg(props)}>
      <path d="M5 4h14a2 2 0 0 1 2 2v9H3V6a2 2 0 0 1 2-2Zm0 2v7h14V6H5ZM2 17h20a1 1 0 0 1 1 1 2 2 0 0 1-2 2H3a2 2 0 0 1-2-2 1 1 0 0 1 1-1Z" />
    </svg>
  );
}
...
export function AppleIcon(props: IconProps) {
  return (
    <svg {...svg(props)}>
      <path d="M12.152 6.896c-.948 0-2.415-1.078-3.96-1.04-2.04.027-3.91 1.183-4.961 3.014-2.117 3.675-.546 9.103 1.519 12.09 1.013 1.454 2.208 3.09 3.792 3.039 1.52-.06 2.09-.987 3.935-.987 1.831 0 2.35.987 3.96.948 1.637-.026 2.676-1.48 3.676-2.948 1.156-1.688 1.636-3.325 1.662-3.415-.036-.014-3.192-1.221-3.226-4.856-.026-3.03 2.48-4.482 2.597-4.549-1.427-2.097-3.635-2.328-4.402-2.373-2.008-.163-3.706 1.079-4.583 1.079zM15.53 3.83c.843-1.02 1.412-2.436 1.256-3.842-1.213.049-2.681.809-3.55 1.83-.78.9-1.464 2.35-1.28 3.717 1.335.104 2.708-.679 3.573-1.704" />
    </svg>
  );
}
...
export function GooglePlayBadge({ className, height = 52 }: { className?: string; height?: number }) {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <rect x="1.5" y="1.5" width="643" height="197" rx="30" fill="#D1E6D3" stroke="#9EC0A6" strokeWidth="3" />
      {/* Play triangle logo */}
